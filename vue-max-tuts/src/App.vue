      ...
      <div class="row">
        ...
        >
          <label for="priority">Priority</label>
              <!-- option 1 for default selected priority -->
          <select id="priority" class="form-control" v-model="selectedPriority">
              <!-- option 2 for default selected priority -->
            <option v-for="priority in priorities" v-bind:key="priority" :selected="priority == 'Medium'"> {{ priority }} </option>
          </select>
        </div>
      </div>
      <hr />
